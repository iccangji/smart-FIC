...
export default function Edit({ point }) {
    ...
    const submit = (e) => {
        e.preventDefault();
        put(`/admin/points/${point.id}`);
    };

    return (
        <MainLayout
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Edit Titik Kualitas Udara</h2>}
        >
            <Head><title>Edit Titik - Kualitas Udara</title></Head>
            <div className="p-4 md:p-6">
                <div className="max-w-2xl mx-auto bg-white overflow-hidden shadow-sm rounded-lg p-6">
                    <h3 className="text-lg font-semibold text-gray-900 mb-6">Form Edit Titik Kualitas Udara</h3>
